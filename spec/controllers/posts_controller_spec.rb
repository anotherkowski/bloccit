...
# MEMBER EDITING ANOTHER USER'S POST
...
# MODERATOR USER
  ...
  context "moderator doing CRU on any post" do
    before do
  ...
  context "moderator deleting a post they don't own" do
    before do
      other_user.moderator!
      create_session(other_user)
    end
  ...
  context "moderator deleting a post they own" do
    before do
      my_user.moderator!
      create_session(my_user)
    end
